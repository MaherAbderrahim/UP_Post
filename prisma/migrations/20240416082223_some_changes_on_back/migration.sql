...
CREATE TABLE "Posts_IG" (
    ...
    "Total_NB_commentaires" INTEGER NOT NULL,
    "len_post" INTEGER NOT NULL,
    "langue_post" TEXT NOT NULL,
    "Hashtags" TEXT NOT NULL,
    "hashtag_count" INTEGER NOT NULL,
    "Found_Hash" INTEGER NOT NULL,
    "Day_of_Week" TEXT NOT NULL,
    "Time_post" TIMESTAMP(3) NOT NULL,
    "Day" INTEGER NOT NULL,
    "Month" TEXT NOT NULL,
    "Year" INTEGER NOT NULL,
    "Date_post" TIMESTAMP(3) NOT NULL,
    "Sentiment_POSTT" TEXT NOT NULL,
    "sentiment_comment" JSONB NOT NULL,
