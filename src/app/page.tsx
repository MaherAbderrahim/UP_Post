    ...
    <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
      ...
      <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
        <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
          <span className="block text-white">Optimisez vos publications </span>
          <span className="block text-indigo-200">pour un engagement maximal</span>
        </h1>
        <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
          Obtenez une version optimisée de vos publications grâce à notre service. 
          Assurez-vous un meilleur engagement et une plus grande portée avec notre plateforme.
        </p>
      ...
      <ContainerScroll
        titleComponent={
          <>
            ...
            Suivez l'évolution de vos publications <br />
              ...
              <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    Évaluation Dynamique de Performance
                    </h2>
                    <p className="mt-4 text-lg text-gray-500">
                        Notre plateforme évalue la performance de chaque publication, fournissant des insights précieux sur leur efficacité. 
                        Cela permet aux utilisateurs de comprendre ce qui fonctionne et ce qui ne fonctionne pas, 
                        les aidant à affiner leur stratégie de contenu.
                    </p>
                    <div className="mt-6">
                      <a
                        href="/sign-up"
                  ...
                  <blockquote>
                    <div>
                      <p className="text-base text-gray-500">
                        &ldquo;je suis vraiment impressionné par cette fonctionnalité. L’évaluation de la performance de chaque publication est un outil inestimable pour toute stratégie de contenu.&rdquo;
                      </p>
                    </div>
        ...
        <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
          <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
            <div>
              ...
              <div className="mt-6">
                <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">
                Améliorez vos publications avec notre plateforme innovante
                </h2>
                <p className="mt-4 text-lg text-gray-500">
                Pour les publications qui n'atteignent pas leur plein potentiel, notre service utilise des algorithmes avancés pour les améliorer. 
                En passant par notre Service, les utilisateurs peuvent obtenir une version optimisée de leurs publications, 
                garantissant un meilleur engagement et une plus grande portée.
                </p>
                <div className="mt-6">
                  <a
                    href="#"
            ...
            <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
              <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
                <div>
                  ...
                  <div className="mt-6">
                    <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">
                    Créez du contenu attrayant à partir de zéro
                    </h2>
                    <p className="mt-4 text-lg text-gray-500">
                    Notre plateforme offre la possibilité de créer du contenu à partir de zéro. 
                    Les utilisateurs peuvent fournir un thème ou une idée, et nous nous chargeons de générer une publication 
                    pertinente et attrayante pour leur public cible.
                ...
                <div className="mt-8 border-t border-gray-200 pt-6">
                  <blockquote>
                    <div>
                      <p className="text-base text-gray-500">
                        &ldquo;Je trouve cette fonctionnalité extrêmement précieuse. La possibilité de créer du contenu 
                        à partir de zéro est un véritable game-changer.&rdquo;
                      </p>
                    </div>
                    <footer className="mt-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="text-base font-medium text-gray-700">
                          Elinore Hamlton, Digital Marketing Manager
                        </div>
                      </div>
                    </footer>
                  </blockquote>
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2020 WEREACT, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
